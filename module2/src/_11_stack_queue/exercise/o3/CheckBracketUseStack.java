package _11_stack_queue.exercise.o3;
    ...
    private static boolean checkBracket(String val) {
        ...
        for (int i = 0; i < size; i++) {
            if (tmp[i].charAt(0) == LEFT_BRACKET) {
                ...
                if (i!=0 && tmp[i - 1].charAt(0) != ADDITION && tmp[i - 1].charAt(0) != SUBTRACTION && tmp[i - 1].charAt(0) != DIVISION && tmp[i - 1].charAt(0) != MULTIPLICATION)
                    return false;
            }
